...
function LeadershipNew() {
        ...
        layers.forEach(
            ({ names, innerR, outerR }) => {
                names.forEach((name, index) => {
                    ...
                    const patternId = `pattern-${name.replace(
                        /\s/g,
                        ""
                    )}`;
    ...
    return (
        <div className={styles.div_wrapper}>
            <h1 className={styles.h1_leadership}>
                Leadership Stewards
            </h1>

            <div className={styles.div_SBCLeadership}>
                <NextImage
                    src={christCenter}
                ...
                {stewards.length > 0 && (
                    <svg
                        className={styles.svg_quarterCircle}
                        viewBox="0 0 100 100"
                ...
                <div
                    className={`div_column ${styles.stewardInfo}`}
                >
                    {steward && (
                        <NextImage
                            src={steward.iconImg.trim()}
                            alt={steward.name}
                            width={500}
                            height={500}
                        />
            ...
            {stewards.length > 0 &&
                ...
                (() => {
                    ...
                    return (
                        <div
                            className={
                                styles.div_stewardInfo_mn
                            }
                        >
                            <div className="div_row">
                                <div
                                    className={`div_column ${styles.div_info_mn}`}
                                >
                                    <h2>
                                        {steward.name}
                                    </h2>
